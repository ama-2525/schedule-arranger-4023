...
const GITHUB_CLIENT_ID = proccess.env.GITHUB_CLIENT_ID || '2f831cb3d4aac02393aa';
const GITHUB_CLIENT_SECRET = proccess.env.GITHUB_CLIENT_SECRET || '9fbc340ac0175123695d2dedfbdf5a78df3b8067';
...
passport.use(new GitHubStrategy({
    ...
    callbackURL: proccess.env.CALLBACK_URL || 'http://localhost:8000/auth/github/callback'
  },
